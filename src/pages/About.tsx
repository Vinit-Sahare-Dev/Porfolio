        ...
        <section className="py-24 md:py-32 px-6 lg:px-8 border-b border-border">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <motion.div initial={{ opacity: 0.8, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-4">About Me</h1>
              <p className="text-lg md:text-xl text-muted-foreground">{developerInfo.tagline}</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 px-6 lg:px-8">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-2"><Briefcase className="size-5" /> Experience</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-2"><GraduationCap className="size-5" /> Education</h2>
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-semibold flex items-center gap-2"><Award className="size-5" /> Achievements</h2>
